 ...
 * [ResultsWinner.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ResultsWinner.newInstance] factory method to
...
class ResultsWinner : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.match_btn).setOnClickListener {
