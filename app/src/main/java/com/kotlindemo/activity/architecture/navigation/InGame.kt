package com.kotlindemo.activity.architecture.navigation
 ...
 * [InGame.OnFragmentInteractionListener] interface
...
class InGame : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<View>(R.id.winner_btn).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_inGame_to_resultsWinner)
        }

        view.findViewById<View>(R.id.game_over_btn).setOnClickListener {
